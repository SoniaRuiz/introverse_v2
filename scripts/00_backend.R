...
database_equivalences <- data.frame(index = c(1,2,3,4,5),
                                    ...
                                    name_title = c("The Cancer Genome Atlas Program (TCGA) database",
                                                   ...
                                                   "The Genotype Tissue Expression v8 (GTEx) database - Age Stratification",
                                                   #"Parkinson's Disease",
                                                   #"Alzheimer's Disease",
                                    ...
                                    name = c("TCGA",
                                             "GTEx v8",
                                             "GTEx v8 - Age stratification", 
                                             #"PD/Control",
                                             #"AD/Control", 
                                             "ENCODE shRNA", 
                                             "ENCODE CRISPR"),
                                    sqlite_file = c("TCGA_1read_subsampleFALSE.sqlite", 
                                                    "GTEX_1read_subsampleFALSE.sqlite",
                                                    "GTEX_1read_subsampleFALSE_age.sqlite", 
                                    ...
                                    project_types = c("cancer types",
                                                      ...
                                                      "RBP CRISPR knockdown experiments"))#, "AD samples" , "PD samples" ))
