                            ...
                            fluidRow(
                              ...
                              column(width = 8, 
                                     ...
                                     div(
                                       ...
                                       across more than 27K individual RNA-sequencing human samples of diverse ancestries and cell lines, sequenced as part of various large-scale publicly-available RNA-sequencing studies, which include: 
                                         i) the Genotype-Tissue Expression (GTEx) dataset, covering >17K human samples from 54 non-diseased tissues in a tissue- and age-stratification manner (PMID: 32913098); 
                                         ii) The Cancer Genome Atlas Program (TGCA), spanning >11K human samples from 33 cancer types and matched control samples (PMID: 24071849); 
                                         and iii) ENCODE's extensive analysis of RBP activity generated by targeting >140 RBPs using either short-hairpin or CRISPR knockdowns to generate a case-control data set of >1.1K RNA-sequencing samples (PMID: 32728246)."),
                                       p("In addition, IntroVerse 2.0 has been enriched with information on i) RBP-RNA interactions supported by >20m binding sites generated through >17K CLIP-seq experiments (PMID: 24297251)  
                                         and ii) ClinVar data (PMID: 29165669), the latter providing with granular information about the location and classification of potential pathogenic variation. 
                                       ...
                                       h2("Publications"),
                                       p("Check out these publications to learn more about IntroVerse 2.0 and how to use it for research interpretation."),
                                       tags$ul(
                                         tags$li(a(href="https://academic.oup.com/nar/article/51/D1/D167/6833238", target="_blank", 
                                                   "IntroVerse: a comprehensive database of introns across human tissues"), span("S García-Ruiz et. al, Nucleic Acids Research, Volume 51, Issue D1, 6 January 2023, Pages D167–D178, https://doi.org/10.1093/nar/gkac1056")),
                                         tags$li(a(href="https://www.biorxiv.org/content/10.1101/2023.03.29.534370v1.full", target="_blank", 
                                                   "Splicing accuracy varies across human introns, tissues and age"), span("S García-Ruiz et. al, bioRxiv 2023.03.29.534370; doi: https://doi.org/10.1101/2023.03.29.534370"))
                                         ),
                                       h2("Database build"),
                                       p("Strict quality control and split-read/transcript processing approaches were followed to build each of the 5 databases included in IntroVerse 2.0."),
                                       p("The diagram below summarises the major steps:"),
                                       br(),
                                       
                                       div(align = "center",
                                           img(src = "front_diagram.v2.png", width="75%", height="auto")),
                              ...
                              p(strong("Select the database and sample group to perform the query.")),
                                                 ...
                                                 shiny::selectInput(inputId = "database_selection_tab1",
                                                                    ...
                                                                    choices = c("All" = "all",
                                                                                ...
                                                                                "The Genotype Tissue Expression v8 (GTEx) database - Age Stratification" = "gtex_age",
...
server <- function(input, output, session) {
  ...
  observeEvent(input$igv_browser_acceptButton_tab1, {
    ...
    if (input$igv_browser_database_sample_type_selection_tab1 != "all") {
      ...
      if (str_detect(string = input$igv_browser_database_selection_tab1, pattern = "age")) {
        #message(bigWig$cluster)
        bigWig <- bigWig %>% 
          filter(cluster %in% c("20-39", "40-59", "60-79"))
      }
    }
